...
class TestEvaluationService:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                "What is the capital of France?", "London", "", id="wrong answer"
            ),
        ],
    )
    @pytest.mark.asyncio
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                "Tehran", "it's great", "cities are great", id="none quesetion"
            ),
            pytest.param(
            ...
            pytest.param(
                "What is a nice beach of Iran?",
                "Kish",
                "Kish is a nice beach of Iran",
                id="correct answer",
            ),
        ],
    )
